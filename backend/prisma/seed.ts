...
async function main() {
  ...
  const t1 = await prisma.treatment.create({
    data: {
      name: "Manual Therapy",
      description:
        "Hands-on mobilisation of joints and soft tissues to reduce pain and restore range of motion.",
      specialty: "Ortho",
      durationMinutes: 45,
      standardSessions: 10,
      benefits: ["Pain relief", "Improved mobility", "Reduced stiffness"],
      conditions: ["Lower back pain", "Neck pain", "Frozen shoulder"],
      pricePerSession: 800,
    },
  });
  ...
  const t2 = await prisma.treatment.create({
    data: {
      ...
      description:
        "Electrical stimulation using TENS and Interferential Therapy to reduce pain and promote healing.",
      specialty: "Ortho",
      durationMinutes: 30,
      standardSessions: 15,
      benefits: ["Pain reduction", "Muscle relaxation", "Faster healing"],
      conditions: ["Arthritis", "Sports injuries", "Post-surgery recovery"],
      pricePerSession: 600,
    },
  });
  ...
  const t3 = await prisma.treatment.create({
    data: {
      ...
      description:
        "Deep tissue ultrasound to promote healing of tendons and ligaments by increasing blood flow.",
      specialty: "Ortho",
      durationMinutes: 20,
      standardSessions: 12,
      benefits: [
      ...
      conditions: ["Tendonitis", "Ligament sprains", "Muscle tears"],
      pricePerSession: 500,
    },
  });
  ...
  const t4 = await prisma.treatment.create({
    data: {
      ...
      description:
        "Comprehensive neurological rehabilitation for stroke survivors to regain motor control and independence.",
      specialty: "Neuro",
      durationMinutes: 60,
      standardSessions: 30,
      benefits: [
      ...
      conditions: ["Stroke", "Hemiplegia", "Gait disorders"],
  ...
  const t5 = await prisma.treatment.create({
    data: {
      ...
      description:
        "Specialised physiotherapy to improve gait, balance and motor function using LSVT BIG techniques.",
      specialty: "Neuro",
      durationMinutes: 60,
      standardSessions: 20,
      benefits: ["Improved gait", "Better balance", "Reduced tremors"],
      conditions: ["Parkinson's disease", "Movement disorders", "Bradykinesia"],
  ...
  const t6 = await prisma.treatment.create({
    data: {
      ...
      description:
        "Targeted physiotherapy for athletes recovering from acute and chronic sports injuries.",
      specialty: "Sports",
      durationMinutes: 60,
      standardSessions: 12,
      benefits: [
      ...
      conditions: ["ACL tear", "Hamstring strain", "Rotator cuff injury"],
  ...
  const t7 = await prisma.treatment.create({
    data: {
      ...
      description:
        "Progressive 6-phase ACL rehabilitation from post-surgery to return-to-sport.",
      specialty: "Sports",
      durationMinutes: 75,
      standardSessions: 24,
      benefits: [
      ...
      conditions: ["ACL rupture", "Post-ACL surgery", "Knee instability"],
      pricePerSession: 1100,
    },
  });
  ...
  const t8 = await prisma.treatment.create({
    data: {
      name: "Dry Needling",
      description:
        "Intramuscular stimulation targeting myofascial trigger points to relieve chronic muscle pain.",
      specialty: "Ortho",
      durationMinutes: 30,
      standardSessions: 8,
      benefits: ["Trigger point release", "Muscle relaxation", "Pain relief"],
      conditions: ["Chronic muscle pain", "Fibromyalgia", "Tension headaches"],
      pricePerSession: 900,
    },
  });
  ...
  const m2 = await prisma.machine.create({
    data: {
      ...
      model: "ET-4000",
      description:
        "Dual-channel interferential and TENS therapy unit for pain management.",
      specialty: "Ortho",
  ...
  const m3 = await prisma.machine.create({
    data: {
      ...
      model: "Mercury",
      description:
        "Medical treadmill with body-weight support for neurological gait rehab.",
      specialty: "Neuro",
      certifications: ["Medical CE", "TÜV Certified"],
  ...
  const m4 = await prisma.machine.create({
    data: {
      ...
      description:
        "Radial shockwave therapy for chronic tendinopathies and calcifications.",
      specialty: "Sports",
  ...
  const m5 = await prisma.machine.create({
    data: {
      ...
      specialty: "Sports",
      certifications: ["FDA Cleared", "Class II Medical Device"],
  ...
  await prisma.patientStory.createMany({
    data: [
      ...
      },
      {
        ...
        storyText:
          "I suffered from chronic neck pain for over 3 years affecting my work and sleep. After trying multiple treatments elsewhere, ONS Healthcare gave me a personalised plan combining manual therapy, traction and posture correction. I was pain-free in just 6 weeks. Highly recommended!",
